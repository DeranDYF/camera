            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ route('dashboard') }}" class="app-brand-link">
                        ...
                        <img class="app-brand-logo ms-2" id="logo1" src="../../assets/img/D2.png" data-app-dark-img="../../assets/img/D.png" style="width: 23px;" />
                        <span class="app-brand-text menu-text">
                            <img id="logo2" src="../../assets/img/yfzn2.png" data-app-dark-img="../../assets/img/yfzn.png" class="app-brand-logo" style="width: 80px;" />
                        </span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Layouts -->
                    <!-- tambahkan class "active open ketika menu active" -->
                    <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('category') }}" class="menu-link @if($activeMenu === 'category') active @endif">
                    ...
                    <li class="menu-item">
                        <a href="app-kanban.html" class="menu-link @if($activeMenu === 'user') active @endif">
                            <i class="menu-icon tf-icons ti ti-camera"></i>
                            <div data-i18n="Equipment">Equipment</div>
                        </a>
                    </li>
                    <li class="menu-item @if($activeMenu === 'user' OR $activeMenu === 'role' OR $activeMenu === 'permissions') active open @endif">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item @if($activeMenu === 'permissions') active @endif">
                                <a href="{{ route('dashboard') }}" class="menu-link">
                        ...
                        <div class="container-xxl">
                            <div class="footer-container d-flex align-items-center justify-content-between py-2 flex-md-row flex-column">
                                <div>
                                    ...
                                    , made with ❤️ by <a href="https://instagram/derandyfzn_" target="_blank" class="fw-semibold">Dyfznnn</a>
                                </div>
                                <div>
