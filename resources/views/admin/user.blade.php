    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="card-datatable table-responsive pt-0">
                <table class="datatables-user table" id="table_user">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Name</th>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row g-2">
                                            <div class="col mb-0">
                                                ...
                                                <select id="role_edit" class="select2 form-select" name="role"
            ...
            <form method="POST" action="{{ route('adduser') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-2">
                        <div class="col mb-0">
                            <label for="role" class="form-label">Role</label>
                            <select id="role_add" class="select2 form-select" name="role" data-allow-clear="true">
                                @foreach ($role as $rl)
                                <option value="{{ $rl->id }}">{{ $rl->name }}</option>
                                @endforeach
                            </select>
