...
<div class="card-body">
    ...
    <div class="card">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <button type="button" class="btn bts-sm btn-label-primary mx-3" data-bs-toggle="modal" data-bs-target="#modalAddRole">Add Role
            </button>
        </div>
                    ...
                    <td class="text-center">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modalEditRole{{ $rl->id }}">
                                    Edit
                                </button>
                                <button type="button" class="dropdown-item btn-label-danger" id="confirm-text{{ $rl->id }}">Delete</button>
                            </div>
                        </div>
                    </td>
                </tr>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col mb-3">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control mb-3" value="{{ $rl->name }}" />
                                            <label for="descriptions" class="form-label">Descriptions</label>
                                            <input type="text" name="descriptions" id="descriptions" class="form-control" value="{{ $rl->descriptions }}" />
                                        </div>
                                    </div>
                                </div>
            ...
            <form method="POST" action="{{ route('addrole') }}">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col mb-3">
                            <label for="name" class="form-label">Name</label>
                            <input type="text" name="name" id="name" class="form-control mb-3" placeholder="Enter Role Name" />
                            <label for="descriptions" class="form-label">Descriptions</label>
                            <input type="text" name="descriptions" id="descriptions" class="form-control" placeholder="Enter Descriptions" />
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
